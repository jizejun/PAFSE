...
```
conda create --name pafse_env python=3.8
source activate pafse_env
...
### Reproducing results of PAFSE

In order to reproduce the results of PAFSE on the four datasets in the paper, run the following commands
